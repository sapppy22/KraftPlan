...
export default function RootPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-bg-base relative overflow-hidden transition-colors duration-300">
      ...
      <header className="px-6 sm:px-8 py-6 flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/login" className="hidden sm:inline text-text-secondary hover:text-text-primary transition-colors text-sm font-medium">
            Log In
          </Link>
          <Link href="/register">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 text-center relative z-10 -mt-20">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface-1 border border-hairline mb-8 backdrop-blur-md">
