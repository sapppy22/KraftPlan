// WebCrypto PBKDF2 — identical scheme to the Cloudflare Worker (apps/worker),
// so both backends produce/verify the same hashes against the shared Neon DB.
// Uses the global `crypto.subtle` available on Node 20+ and on Workers.
